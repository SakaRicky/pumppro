...
export async function seed() {
	...
	try {
		...
		const expextedUser1Amount =
			product1.selling_price.toNumber() * 2 +
			product2.selling_price.toNumber() * 1 +
			product3.selling_price.toNumber() * 14;
	
		const amountGivenUser1 =
			product1.selling_price.toNumber() * 2 + product3.selling_price.toNumber() * 14;
		...
		const expextedAmountUser2 =
			product4.selling_price.toNumber() * 4 +
			product5.selling_price.toNumber() * 7 +
			product7.selling_price.toNumber() * 6 +
			product8.selling_price.toNumber() * 1;
